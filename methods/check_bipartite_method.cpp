...
@brief Серверная часть алгоритма проверки графа на двудольность.
*/
...
namespace graph {
    ...
    /**
    @brief Серверный метод для проверки графа на двудольность.

    @param input Входной JSON с данными графа.
    @param output Указатель на выходной JSON для записи результата.
